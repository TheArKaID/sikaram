                    ...
                    <div class="row slide-margin">
                        <div class="col-sm-6">
                            <div class="carousel-content">
                                ...
                                <h2 class="animation animated-item-2">“Barangsiapa menempuh jalan menuntut ilmu, maka
                                    Allah akan memudahkan jalannya untuk menuju surga”
                                    (HR. At Tirmidzi no. 2682, Abu Daud no. 3641, dishahihkan Al Albani dalam Shahih Abu
                                    Daud).</h2>
                            </div>
                        </div>
                        <div class="col-sm-6 hidden-xs animation animated-item-4">
                    ...
                    <div class="row slide-margin">
                        <div class="col-sm-6">
                            <div class="carousel-content">
                                ...
                                <h2 class="animation animated-item-2">Allah SWT berfirman dalam Al-Qur’an Surah
                                    Al-Baqarah ayat 148, yang artinya : ”Dan bagi tiap-tiap umat ada kiblatnya (sendiri)
                                    ...
                                    kiamat). Sesungguhnya Allah Maha Kuasa atas segala sesuatu”. (AQS. Al-Baqarah/2:148)
                                </h2>
                            </div>
                        </div>
                        <div class="col-sm-6 hidden-xs animation animated-item-4">
            ...
            <div class="col-sm-8">
                <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    ...
                    <div class="media-body">
                        ...
                        <p>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيم<br>Mari belajar bersama dengan kelompok kami, di
                            Universitas Muhammadiyah Yogyakarta , Fakultas Teknik , Tehnologi Informasi +0123 456 70 80
                            90</p>
                    </div>
                </div>
            </div>
